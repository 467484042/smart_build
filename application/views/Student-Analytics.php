		...
		<div class="flex-video infoBox">
			...
			<?php if($this->session->userdata('grade')<6) : ?>
				...
				<div class="first video">
					Your score has exceeded the average score, we recommend some
					<span style="color:purple"> Advanced Design Concepts</span>
					for you to get better results, you can watch this section of the
					<span style="color:purple"> video </span>

...
<head>
    ...
    <title>Course3801-Anouncement</title>
</head>
<body>
<box>
    <nav id="coursebar">
        <a href="http://localhost/smart_build/index.php/course"><img id="exit" src=<?php echo base_url().'smart_build/assets//images/exit.png';?>></a>
...
<div id="Coursecontent">
    <div id="course-title"><p>Anouncement</p></div>
    <div id="content-2"><p>Welcome to Studio 3 Build（Deco 3801）</p>

    <p> In this course,you will work in teams to build a software product.You will be able to choose from a 
    set of pre-defined proposals and develop these through from a specification to a minimum viable
    product and ultimately to a product for showcasing in a trade show(EXPO)environment at

...
<!--      Content       -->
    <div id="content">
        <div id ="quiz" style="margin-left:50px; margin-top:30px;">
                <form action="<?php echo base_url().'smart_build/index.php/quiz/result'?>" method="POST">
					<?php
						if(sizeof($question)>=1){
							for($i = 0; $i < sizeof($question); $i++){
								...
								echo "<input type=\"radio\" id=\"Q".$i."A\" name=\"".$question[$i]->qname."\" value=\"Q".$n."A\">";
								echo "<label for=\"Q".$n."A\">".$question[$i]->choiceA."</label><br>";
								echo "<input type=\"radio\" id=\"Q".$i."B\" name=\"".$question[$i]->qname."\" value=\"Q".$n."B\">";
								echo "<label for=\"Q".$n."B\">".$question[$i]->choiceB."</label><br>";
								echo "<input type=\"radio\" id=\"Q".$i."C\" name=\"".$question[$i]->qname."\" value=\"Q".$n."C\">";
								echo "<label for=\"Q".$n."C\">".$question[$i]->choiceC."</label><br>";
								echo "<input type=\"radio\" id=\"Q".$i."D\" name=\"".$question[$i]->qname."\" value=\"Q".$n."D\">";
								echo "<label for=\"Q".$n."D\">".$question[$i]->choiceD."</label><br>";
								echo "<br>";
							}
...
<!--					<label for="age3">61 - 100</label><br><br>-->
		...
		<div id ="quiz" style="margin-left:50px; margin-top:30px; display: none;">
			<form action="<?php echo base_url().'smart_build/index.php/quiz/result'?>" method="POST">
				<?php
				if(sizeof($question)>=1){
					for($i = 0; $i < sizeof($question); $i++){
						...
						echo "Your Answer is :".$user_ans[0]."<br>";
						echo "<br>";
					}

...
<div id="Coursecontent">
    ...
    <div id="content-3">
    <figure>
        <img src=<?php echo base_url().'smart_build/assets/images/boy.png';?> width="80px"height="80px">
        ...
        <div class="side-image">
            <img src=<?php echo base_url().'smart_build/assets/images/comment.png';?> width:="15px" height="15px">
            <img src=<?php echo base_url().'smart_build/assets/images/eye.png';?> width:="15px" height="15px">
            <img src=<?php echo base_url().'smart_build/assets/images/time.png';?> width:="15px" height="15px">
        </div>
    </figure>
    <figure>
        <img src=<?php echo base_url().'smart_build/assets/images/girl.png';?> width="80px"height="80px"> 
    ...
    <figure>
        <img src=<?php echo base_url().'smart_build/assets/images/boy2.png';?> width="80px"height="80px">
    ...
    <h3>Categories</h3>
        ...
        <tr>
            <td>Assignment 1</td>
            <td><span style="background-color: grey; border-radius: 0.7em;">8</span></td>
        </tr>
        <tr>
            <td>Assignment 2:</td>
            <td><span style="background-color: grey; border-radius: 0.7em;">21</span></td>
        </tr>
        <tr>
            <td>Assignment 3:</td>
            <td><span style="background-color: grey; border-radius: 0.7em;">13</span></td>
        </tr>
        <tr>
            <td>Other:</td>
            <td><span style="background-color: grey; border-radius: 0.7em;">2</span></td>
        </tr>
        <tr>
            <td>Mid-term Exam</td>
            <td><span style="background-color: grey; border-radius: 0.7em;">16</span></td>
        </tr>
        <tr>
            <td>Final Exam</td>
            <td><span style="background-color: grey; border-radius: 0.7em;">32</span></td>
        </tr>
        </table>
</div>

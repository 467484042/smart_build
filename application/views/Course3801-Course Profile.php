...
<head>
    ...
    <title>Course3801-CourseProfile</title>
</head>
<body>
<box>
    <nav id="coursebar">
...
<div id="Coursecontent">
    <div id="course-title"><h1>Course Profile</h1></div>
    <div id="content-2"><p>Course Title:Studio3-Build</p>
        <p>Coordinating Unit:School of Information Technology And Electrical Engineering</p>
        <p>Mode:External</p>
        <p>Number of Units:2</p>
        <p>Incompatible:CSSE3004 or CSSE3005</p>
        <p>Descreiption:A studio-based course in which interdisciplinary teams of students build a 
            signficant software-based system according to client requirements and project
            deadlines.The course aims to consolidate and expand on students previous experience with 
            implementing information systems,user interfaces,and computer software and 
            systems.Subjects such as project planning risk management and software quality assurance are covered during the course.
        </p>

...
<div id="Coursecontent">
    <div id="course-title"><p>My Grades</p></div>
    <div id="content-5">
        ...
        <a href="#"><p>View all works(33)</p></a>
</div>
...
<div id="content-6">
   <table id="grades-table">
    ...
    <tr>
        ...
        <td><span style="color: green;">90%</span></td>
    </tr>
    <tr>
        <td>Quiz:</td>
        <td><span style="color: green;">65/75</span></td>
    </tr>
    <tr>
        <td>Assignment 1:</td>
        <td><span style="color: green;">80/100</span></td>
    </tr>
    <tr>
        <td>Assignment 2:</td>
        <td><span style="color: green;">80/100</span></td>

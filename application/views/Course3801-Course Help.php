...
<head>
    ...
    <title>Course3801-Course Help</title>
</head>
<body>
<box>
    <nav id="coursebar">
...
<div id="Coursecontent">
    <div id="course-title"><p>Course Help</p></div>
    <div id="content-2">
        <figure>
            <img src=<?php echo base_url().'smart_build/assets/images/paper.png';?>>
            <p><a href="#" target="_self"> Assessment extensions</a>
            <br>If you have a case for extensions of the due dates for your assessment items you may apply for an extension.
            <br>Extension requests for assessment items should be submitted by logging the appropriate(online) form. For more details see the course ECP.</p>
        </figure>
    </div>
